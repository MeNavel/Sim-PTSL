...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Sumberagung</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('sumberagung.index') }}">Sumberagung</a></li>
    ...
    <form action="{{ route('sumberagung.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="BANJAREJO TIMUR" @selected($data->dusun == "BANJAREJO TIMUR")>BANJAREJO TIMUR
                                    </option>
                                    <option value="BANJAREJO BARAT" @selected($data->dusun == "BANJAREJO BARAT")>BANJAREJO BARAT
                                    <option value="BANJAREJO TENGAH" @selected($data->dusun == "BANJAREJO TENGAH")>BANJAREJO TENGAH
                                    </option>
                                    <option value="TAMBAKREJO" @selected($data->dusun == "TAMBAKREJO")>TAMBAKREJO
                                    </option>
                                </select>
                            </div>
                        </div>
