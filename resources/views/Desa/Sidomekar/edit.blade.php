...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Sidomekar</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('sidomekar.index') }}">Sidomekar</a></li>
    ...
    <form action="{{ route('sidomekar.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="BETENG" @selected($data->dusun == "BETENG")>BETENG
                                    </option>
                                    <option value="BABATAN" @selected($data->dusun == "BABATAN")>BABATAN
                                    <option value="BESUKI" @selected($data->dusun == "BESUKI")>BESUKI
                                    </option>
                                </select>
                            </div>
                        </div>
