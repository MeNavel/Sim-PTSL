...
@section('content')
    <div class="pagetitle">
        <h1>Formulir Pendaftaran Sertifikat Tanah Desa Sidomekar</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <form action="{{ route('sidomekar.store') }}" method="POST">
        @csrf
        <div class="row">
            {{--Spesifikasi Data--}}
            <div class="col-lg-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="BETENG" selected>BETENG</option>
