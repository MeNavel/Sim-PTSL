...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Patemon</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <form action="{{ route('patemon.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="KRAJAN 1" @selected($data->dusun == "KRAJAN 1")>KRAJAN 1
                                    </option>
                                    <option value="KRAJAN 2" @selected($data->dusun == "KRAJAN 2")>KRAJAN 2
                                    </option>
                                    <option value="CURAH PUTIH" @selected($data->dusun == "CURAH PUTIH")>CURAH PUTIH
                                    </option>
                                </select>
                            </div>
                        </div>
