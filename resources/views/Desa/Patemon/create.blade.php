...
@section('content')
    <div class="pagetitle">
        <h1>Formulir Pendaftaran Sertifikat Tanah Desa Patemon</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('patemon.index') }}">Patemon</a></li>
    ...
    <form action="{{ route('patemon.store') }}" method="POST">
        @csrf
        <div class="row">
            {{--Spesifikasi Data--}}
            <div class="col-lg-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="KRAJAN 1" selected>KRAJAN 1</option>
                                    <option value="KRAJAN 2">KRAJAN 2</option>
                                    <option value="CURAH PUTIH">CURAH PUTIH</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        success: function (result) {
                            if (result.success === false) {
                                ...
                                document.getElementById("hasil_cek").addEventListener("click", function() {
                                    ...
                                    var url = "{{ route('patemon.edit', ':patemon') }}";
                                    url = url.replace(':patemon', inputValue);
