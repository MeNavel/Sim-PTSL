...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Sidomulyo</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('sidomulyo.index') }}">Sidomulyo</a></li>
    ...
    <form action="{{ route('sidomulyo.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="PUCUAN" @selected($data->dusun == "PUCUAN")>PUCUAN
                                    </option>
                                    <option value="ROWOTENGU" @selected($data->dusun == "ROWOTENGU")>ROWOTENGU
                                    </option>
                                </select>
                            </div>
                        </div>
