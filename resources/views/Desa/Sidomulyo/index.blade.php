...
@section('content')
    <div class="pagetitle">
        <h1>Daftar Permohonan Sertifikat Tanah Desa Sidomulyo</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active">Sidomulyo</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @can('sidomulyo-create')
                <a href="{{ route('sidomulyo.create') }}" role="button" class="btn btn-primary mb-2"><i
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            var id = $(this).data('id');
                            $.ajax({
                                url: '{{ route('sidomulyo.destroy', '') }}/' + id,
                                type: 'DELETE',
                                data: {
