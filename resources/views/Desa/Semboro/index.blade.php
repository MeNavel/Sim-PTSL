...
@section('content')
    <div class="pagetitle">
        <h1>Daftar Permohonan Sertifikat Tanah Desa Semboro</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active">Semboro</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @can('semboro-create')
                <a href="{{ route('semboro.create') }}" role="button" class="btn btn-primary mb-2"><i
