...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Semboro</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <form action="{{ route('semboro.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="SEMBORO LOR" @selected($data->dusun == "SEMBORO LOR")>SEMBORO LOR
                                    </option>
