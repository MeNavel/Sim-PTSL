...
@section('content')
    <div class="pagetitle">
        <h1>Daftar Permohonan Sertifikat Tanah Desa Kramat Sukoharjo</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active">Kramat Sukoharjo</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Pengajuan TA 2024</h5>
            ...
            @can('kramatsukoharjo-create')
                <a href="{{ route('kramatsukoharjo.create') }}" role="button" class="btn btn-primary mb-2"><i
        ...
        <script type="text/javascript">
            $(function () {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    ajax: "{{ route('kramatsukoharjo.index') }}",
                    columns: [
                        {
                            data: 'action',
                            name: 'action',
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            var id = $(this).data('id');
                            $.ajax({
                                url: '{{ route('kramatsukoharjo.destroy', '') }}/' + id,
                                type: 'DELETE',
                                data: {
