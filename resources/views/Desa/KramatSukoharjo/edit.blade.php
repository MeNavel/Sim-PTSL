...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Kramat Sukoharjo</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <form action="{{ route('kramatsukoharjo.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="status_penggunaan" name="status_penggunaan"
                                        aria-label="State">
                                    <option value="TANAH PEKARANGAN" @selected($data->status_penggunaan == "TANAH PEKARANGAN")>
                                        TANAH PEKARANGAN
                                    </option>
                                    <option
                                        value="TANAH PEKARANGAN BERDIRI BANGUNAN" @selected($data->status_penggunaan == "TANAH PEKARANGAN BERDIRI BANGUNAN")>
                                        TANAH PEKARANGAN BERDIRI BANGUNAN
                                    </option>
                                    <option value="TANAH PERTANIAN" @selected($data->status_penggunaan == "TANAH PERTANIAN")>TANAH PERTANIAN</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
