...
@section('content')
    <div class="pagetitle">
        <h1>Daftar Permohonan Sertifikat Tanah Desa Mundurejo</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active">Mundurejo</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @can('mundurejo-create')
                <a href="{{ route('mundurejo.create') }}" role="button" class="btn btn-primary mb-2"><i
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            var id = $(this).data('id');
                            $.ajax({
                                url: '{{ route('mundurejo.destroy', '') }}/' + id,
                                type: 'DELETE',
                                data: {
