...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Mundurejo</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('mundurejo.index') }}">Mundurejo</a></li>
    ...
    <form action="{{ route('mundurejo.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="TEMUREJO" @selected($data->dusun == "TEMUREJO")>TEMUREJO
                                    </option>
                                    <option value="SUKOMAKMUR" @selected($data->dusun == "SUKOMAKMUR")>SUKOMAKMUR
                                    </option>
                                    <option value="BLOGMUNDU" @selected($data->dusun == "BLOGMUNDU")>BLOGMUNDU
                                    </option>
                                </select>
                            </div>
                        </div>
