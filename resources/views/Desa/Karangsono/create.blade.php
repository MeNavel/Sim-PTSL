...
@section('content')
    <div class="pagetitle">
        <h1>Formulir Pendaftaran Sertifikat Tanah Desa Karangsono</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('karangsono.index') }}">Karangsono</a></li>
    ...
    <form action="{{ route('karangsono.store') }}" method="POST">
        @csrf
        <div class="row">
            {{--Spesifikasi Data--}}
            <div class="col-lg-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="GUMUKREJO" selected>GUMUKREJO</option>
                                    <option value="KRAJAN">KRAJAN</option>
                                    <option value="BEGELENAN">BEGELENAN</option>
                                    <option value="CURAH KETING">CURAH KETING</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        success: function (result) {
                            if (result.success === false) {
                                ...
                                document.getElementById("hasil_cek").addEventListener("click", function() {
                                    ...
                                    var url = "{{ route('karangsono.edit', ':karangsono') }}";
                                    url = url.replace(':karangsono', inputValue);
