...
@section('content')
    <div class="pagetitle">
        <h1>Daftar Permohonan Sertifikat Tanah Desa Karangsono</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active">Karangsono</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @can('karangsono-create')
                <a href="{{ route('karangsono.create') }}" role="button" class="btn btn-primary mb-2"><i
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            var id = $(this).data('id');
                            $.ajax({
                                url: '{{ route('karangsono.destroy', '') }}/' + id,
                                type: 'DELETE',
                                data: {
