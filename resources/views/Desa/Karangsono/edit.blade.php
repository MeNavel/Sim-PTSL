...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Karangsono</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <form action="{{ route('karangsono.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="GUMUKREJO" @selected($data->dusun == "GUMUKREJO")>GUMUKREJO</option>
                                    <option value="KRAJAN" @selected($data->dusun == "KRAJAN")>KRAJAN</option>
                                    <option value="BEGELENAN" @selected($data->dusun == "BEGELENAN")>BEGELENAN</option>
                                    <option value="CURAH KETING" @selected($data->dusun == "CURAH KETING")>CURAH KETING</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
