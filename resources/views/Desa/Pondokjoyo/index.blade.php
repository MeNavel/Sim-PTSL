...
@section('content')
    <div class="pagetitle">
        <h1>Daftar Permohonan Sertifikat Tanah Desa Pondokjoyo</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active">Pondok Joyo</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @can('pondokjoyo-create')
                <a href="{{ route('pondokjoyo.create') }}" role="button" class="btn btn-primary mb-2"><i
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            var id = $(this).data('id');
                            $.ajax({
                                url: '{{ route('pondokjoyo.destroy', '') }}/' + id,
                                type: 'DELETE',
                                data: {
