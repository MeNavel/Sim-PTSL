...
@section('content')
    <div class="pagetitle">
        <h1>Edit Pendaftaran Sertifikat Tanah Desa Pondokjoyo</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <form action="{{ route('pondokjoyo.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            {{--Spesifikasi Data--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="dusun" name="dusun" aria-label="State">
                                    <option value="SONGON" @selected($data->dusun == "SONGON")>SONGON
                                    </option>
                                    <option value="PONDOK RAMPAL" @selected($data->dusun == "PONDOK RAMPAL")>PONDOK RAMPAL
                                    </option>
                                </select>
                            </div>
                        </div>
