            ...
            <div class="card-body">
                ...
                <table class="table text-center">
                    ...
                    <tr>
                        ...
                        <td>@can('semboro-edit')<a href="{{ route('showDataBPN', 'Semboro') }}"><i class="bi bi-pencil-square"></i></a>@endcan</td>
                    </tr>
                    @endcan
                    @can('sidomulyo-index')
                    <tr>
                        ...
                        <td>@can('sidomulyo-edit')<a href="{{ route('showDataBPN', 'Sidomulyo') }}"><i class="bi bi-pencil-square"></i></a>@endcan</td>
                    </tr>
                    @endcan
                    @can('sidorejo-index')
                    <tr>
                        ...
                        <td>@can('sidorejo-edit')<a href="{{ route('showDataBPN', 'Sidorejo') }}"><i class="bi bi-pencil-square"></i></a>@endcan</td>
                    </tr>
                    @endcan
                    ...
                    <tr>
                        ...
                        <td>@can('pondokjoyo-edit')<a href="{{ route('showDataBPN', 'Pondokjoyo') }}"><i class="bi bi-pencil-square"></i></a>@endcan</td>
                    </tr>
                    @endcan
                    @can('mundurejo-index')
                    <tr>
                        ...
                        <td>@can('mundurejo-edit')<a href="{{ route('showDataBPN', 'Mundurejo') }}"><i class="bi bi-pencil-square"></i></a>@endcan</td>
                    </tr>
                    @endcan
                    ...
                    <tr>
                        ...
                        <td>@can('sumberagung-edit')<a href="{{ route('showDataBPN', 'Sumberagung') }}"><i class="bi bi-pencil-square"></i></a>@endcan</td>
                    </tr>
                    @endcan
                    @can('sidomekar-index')
                    <tr>
                        ...
                        <td>@can('sidomekar-edit')<a href="{{ route('showDataBPN', 'Sidomekar') }}"><i class="bi bi-pencil-square"></i></a>@endcan</td>
                    </tr>
                    @endcan
                    </tbody>
                </table>
